...
void utoa(unsigned int val, char * buf, int base) { buf = NULL; };
void ltoa(unsigned int val, char * buf, int base) { buf = NULL; };
void itoa(unsigned int val, char * buf, int base) { buf = NULL; };
void ultoa(unsigned int val, char * buf, int base) { buf = NULL; };
char * dtostrf(double val, unsigned int a, unsigned int b, char * buf) { buf = NULL; return NULL; };
